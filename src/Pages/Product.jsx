      ...
      <div className='pmain'>
        ...
        <div className="product-list">
          <div style={{display: "flex", flexDirection: "1 column"}}>
            <div>      
              <h1 style={{color:"#FFF"}}>Trending Channel</h1>
              <p style={{color: "#fff"}}>Recommended for you</p>
            </div>
            <div><a href='/youtube'><button style={{marginLeft:"370px", width: "200px"}}>Sell A Channel</button></a></div>
          </div>
          ...
          {products.map(product => (
            <div key={product.id} className="product-item">
              ...
              <h3>{product.name}</h3>
              <p>Subscribers: {product.subscribers}</p>
              <p>Videos: {product.videos}</p>
