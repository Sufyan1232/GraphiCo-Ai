...
function Software() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (image) {
      ...
      try {
        const newProductRef = push(dbRef(db, 'sassProducts'));
    ...
    <div className='you'>
      ...
      <div className='ryou'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input
            type="text"
            placeholder="category like Ai, cloud system, solutions"
            value={subscribers}
          ...
          <input
            type="text"
            placeholder="Provide some Descriopion"
            value={videos}
